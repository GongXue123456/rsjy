...
export default {
  data () {
    ...
    companyPage:{},
      ...
      total: 0,
      tableData:[],
      options:[{user_type:'食品经营者',key:0},{user_type:'乡厨',key:1},{user_type:'举办者',key:2},{user_type:'农家乐',key:3},{user_type:'乡村酒店',key:4},{user_type:'学校食堂',key:5},{user_type:'配送小作坊',key:6}],
      user:'',
