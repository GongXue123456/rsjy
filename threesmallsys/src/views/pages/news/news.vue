    ...
    <el-main class="p15 pt0">
        ...
        <el-form :inline="true" :model="news" class="demo-form-inline">
          <el-col :span="4" class="mr10">
            <el-form-item size="small" >
                    <el-input placeholder="培训标题" v-model="news.news_title" class="input-with-select"></el-input>
            </el-form-item>
          </el-col>
           <el-col :span="4" class="mr10">
         <el-form-item size="small">
          <el-select v-model="news.news_category_code" clearable placeholder="培训栏目" @change="onSubmit">
      ...
      <div class="box list">
        <el-table border :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="news_title"  min-width="150" :show-overflow-tooltip="true"  label="培训标题" align='center'  ></el-table-column>
            ...
            <el-table-column prop="news_summary"  min-width="150" :show-overflow-tooltip="true"  label="培训简介" align='center'  ></el-table-column>
