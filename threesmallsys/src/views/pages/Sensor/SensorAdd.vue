  ...
  <el-container class="camadd">
    ...
    <el-main class="pt0">
      <el-form :label-position="labelPosition"
        ...
        <el-form-item label="绑定小作坊："
                      prop='company_name'
                      :rules="[{required: true,message: '请绑定小作坊',trigger: ['blur','change']}]">
          <el-input v-model="dataForm.company_name"
                    size="small"
                    disabled>
            <el-button slot="append"
                       icon="el-icon-search"
                       @click="handleChooseCompany(1)">请选择小作坊</el-button>
          </el-input>
        </el-form-item>
        <el-form-item label="绑定小作坊区域："
                      prop="company_area_name"
                      :rules="[{required: true,message: '请绑定小作坊区域',trigger: ['blur','change']}]">
          <el-input v-model="dataForm.company_area_name"
                    size="small"
                    disabled>
            <el-button slot="append"
                       icon="el-icon-search"
                       @click="handleChooseCompany(2)">请选择小作坊区域</el-button>
          </el-input>
        </el-form-item>
      ...
      <el-dialog :title="type==1?'小作坊列表':'小作坊区域列表'"
