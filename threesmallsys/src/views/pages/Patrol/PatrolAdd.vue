<template>
     ...
     <el-row class="box mt20  f14">
         ...
         <el-col :span="9" class="tl" :offset="1">
          ...
          <el-form-item class="w" label-width="34%" label="巡查时间：" size="small" prop="patrol_time" :rules="[{required: true,message: '请选择日期', trigger: 'blur' }]">
           <el-date-picker type="date" placeholder="选择日期" v-model="formInline.patrol_time"   format="yyyy-MM-dd" value-format="yyyy-MM-dd" style="width: 100%;" @change="change(3,formInline.patrol_time)"></el-date-picker>
        </el-form-item>
        </el-col>
        <el-col :span="9" class="tl" :offset="1">
  ...
  <el-container v-else-if="formInline.patrol_type==2" class="patroladd">
    <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>日常监督工单派发</h5>
        <div>
             <el-button  class=""  size="small" type="primary" @click="submitForm('formInline')">提交</el-button>
            <el-button  class="back_btn" size="small" plain @click="$router.back()">返回</el-button></div>
    </el-header>
    <el-main class="p15 pt0">
        <el-form :inline="true"  status-icon ref="formInline"  :model="formInline"  class="demo-ruleForm">
     <div class="box mt20 f14">
        <div class="tl c333" >工单号：{{formInline.work_order}}<span class="ml10 f13 patrol_way">日常监督工单派发</span></div>
     </div>
     <el-row class="box mt20  f14">
  ...
  <el-container v-else-if="(formInline.patrol_type==3&&this.$route.query.id2==1)||(formInline.patrol_type==4&&this.$route.query.id2==1)" class="patroladd">
    <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>工单派发</h5>
        <div>
             <el-button  class=""  size="small" type="primary" @click="submitForm('formInline')">提交</el-button>
...
export default {
  ...
  methods: {
     init (params) {
      ...
      if(this.formInline.patrol_type==3||this.formInline.patrol_type==4){
