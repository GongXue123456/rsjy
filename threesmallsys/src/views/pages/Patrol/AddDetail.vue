    ...
    <div class="box mt20 f14">
     ...
     <el-row class="box mt20  f14 c666">
        ...
        <el-col v-if="companytag_code==3" :span="12" class="tl mb20" :offset="1">
          <span class="left">加工的首批食品检验：</span><span class="c333">{{list.food_inspection}}</span>
        </el-col>
        ...
        <el-col :span="9" class="tl mb20" :offset="1">
          <span class="left">加工经营：</span><span class="c333">{{list.production_operation}}</span>
        </el-col>
        <el-col :span="9" class="tl mb20" :offset="1">
          <span class="left">禁止加工经营食品：</span><span class="c333">{{list.ban_production_operation}}</span>
        </el-col>
        <el-col :span="9" class="tl mb20" :offset="1">
         ...
         <el-col v-if="companytag_code==3" :span="9" class="tl mb20" :offset="1">
           <span class="left">禁止加工加工食品：</span><span class="c333">{{list.ban_food}}</span>
        </el-col>
         <el-col v-if="companytag_code==3" :span="9" class="tl mb20" :offset="1">
