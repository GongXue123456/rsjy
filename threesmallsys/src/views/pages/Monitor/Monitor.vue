  ...
  <el-container class="monitor">
    ...
    <el-main class="pt0">
      ...
      <el-table :data="tableData" border fit>
        ...
        <el-table-column prop="company_name" label="小作坊名称" align="center" min-width="150px"></el-table-column>
        <el-table-column label="食品监管分类" align="center">
          <template slot-scope="scope">{{scope.row.companytype_name}}</template>
        </el-table-column>
        <el-table-column label="小作坊主体类型" min-width="150px" align="center">
