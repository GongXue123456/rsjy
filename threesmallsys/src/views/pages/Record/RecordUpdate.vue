<template>
   <el-container class="recordadd ">
      ...
      <el-row class="box mt20 f14">
        ...
        <el-form-item class="w" label-width="34%" label="主体业态：" size="small" prop="business_form" >
          <!-- :rules="[{required: true,message: '主体业态信息为空,需重新备案',trigger: ['blur','change'], }]" -->
       ...
       <el-row class="box mt20  f14">
        ...
        <el-col :span="9" class="tl" :offset="1">
        <el-form-item   class="w" label-width="34%" label="小作坊名称：" size="small" prop="company_name">
           <!-- :rules="[{required: true,message: '小作坊名称信息为空,需重新备案', trigger: 'blur' }]" -->
        ...
        <el-form-item class="w" label-width="34%" label="法人姓名：" size="small"  prop="operator">
           <!-- :rules="[{required: true,message: '法人姓名信息为空,需重新备案', trigger: 'blur' }]" -->
        ...
        <el-form-item class="w" label-width="34%" label="经营者姓名：" size="small"  prop="operator">
           <!-- :rules="[{required: true,message: '经营者姓名信息为空,需重新备案', trigger: 'blur' }]" -->
         <el-input placeholder="请输入经营者姓名"  maxlength="10" clearable v-model="formInline.operator" class="input-with-select">
            </el-input>
        </el-form-item>
        </el-col>
         <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="手机号：" size="small"  prop="mobilephone">
            <!-- :rules="[{type: 'number',message: '手机号信息为空,需重新备案',trigger: 'blur'},{pattern: /^1[3|4|5|7|8|9][0-9]\d{8}$/,message: '手机号格式不对',trigger: 'blur'}]" -->
      ...
      <el-row class="box mt20  f14">
         ...
         <el-col v-if="formInline.companytag_code=='1001574645421581111111103'||formInline.companytag_code=='1001574645421581111111105'"  :span="9" class="tl" :offset="1">
           <el-form-item class="w" label-width="34%" label="统一社会信用代码：" size="small"  prop="credit_code" >
             <!-- :rules="[{required: true, message: '请输入统一社会信用代码', trigger: 'blur' },{ max: 18, message: '请如实填写18位统一社会信用代码，以供核对', trigger: 'blur' }]" -->
           <el-input placeholder="请输入统一社会信用代码"  clearable v-model="formInline.credit_code" class="input-with-select">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col v-if="formInline.companytag_code=='1001574645421581111111103'||formInline.companytag_code=='1001574645421581111111105'"  :span="9" class="tl" :offset="1">
           <el-form-item class="w" label-width="34%" label="食品经营许可证号：" size="small" prop="record_code">
              <!-- :rules="[{required: true, message: '食品经营许可证号信息为空,需重新备案', trigger: 'blur' }]" -->
           <el-input placeholder="食品经营许可证号"  clearable v-model="formInline.record_code" class="input-with-select">
            </el-input>
          </el-form-item>
        </el-col>
         <el-col v-else :span="9" class="tl" :offset="1">
           <el-form-item class="w" label-width="34%" label="备案证号：" size="small" prop="record_code">
              <!-- :rules="[{required: true, message: '备案证号信息为空,需重新备案', trigger: 'blur' }]" -->
           <el-input placeholder="备案证号"  clearable v-model="formInline.record_code" class="input-with-select">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" class="tl" :offset="1">
         <el-form-item  class="w" label-width="34%" label="发证日期：" size="small" prop="issue_time">
            <!-- :rules="[{required: true,message: '请选择发证日期',trigger: 'blur'  }]" -->
         ...
         <el-col :span="9" class="tl" :offset="1">
         <el-form-item  class="w" label-width="34%" label="有效期至：" size="small" prop="unuseful_time">
        ...
        <el-form-item class="w" label-width="14%" label="加工形式：" size="small" prop="produce_form_list">
           <!-- :rules="[{required: true,message: '加工形式信息为空,需重新备案', trigger: 'blur' }]" -->
         ...
         <el-col :span="22" :offset="1" class="tl"  v-if="formInline.companytag_code=='1001574645421581111111101'">
         <el-form-item class="w" label-width="14%" label="加工类别：" size="small" prop="producetype_codes_list">
            <!-- :rules="[{required: true,message: '加工类别信息为空,需重新备案', trigger: 'blur' }]" -->
         ...
         <el-form-item class="w w24" label-width="14%"   label="经营范围：" size="small" prop="business_range_list" >
           <!-- :rules="[{required: true,message: '经营范围信息为空,需重新备案',trigger: ['blur','change'] }]" -->
         ...
         <el-form-item class="w w24" label-width="14%"   label="主营项目：" size="small" prop="main_subject_list">
            <!-- :rules="[{required: true,message: '主营项目信息为空,需重新备案',trigger: ['blur','change'] }]" -->
         ...
         <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="面积：" size="small" prop="place_area" >
           <!-- :rules="[{required: true,message: '面积信息为空,需重新备案', trigger: 'blur'},{ min: 1, message: '最小为1', trigger: 'blur' }]" -->
          <el-input style="width:100px" placeholder="例：20"  min="1" clearable v-model="formInline.place_area" class="input-with-select mr10">
            </el-input>平方米（㎡）
        </el-form-item>
        </el-col>
        <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="从业人数：" size="small" prop="employ_num" >
           <!-- :rules="[{required: true,message: '从业人数信息为空,需重新备案', trigger: 'blur' }]" -->
      ...
      <el-form ref="form" :model="form" >
       <el-table  ref="table" :data="form.List" style="width:100%" empty-text='暂无数据'>
          <el-table-column label="姓名">
           <template slot-scope="scope">
            <el-form-item size="small" :prop="'List.' + scope.$index + '.name'">
               <!-- :rules="[{required: true, message: '姓名信息为空,需重新备案', trigger: 'blur' }]" -->
       ...
       <el-button size="small" type="primary">点击上传</el-button>
         ...
         <el-table-column label="健康证有效期">
          <template slot-scope="scope">
            <el-form-item   size="small" :prop="'List.' + scope.$index + '.time'" >
              <!-- :rules="[{required: true, message: '有效期信息为空,需重新备案', trigger: 'blur' }]" -->
      ...
      <el-row class="box mt20  f14">
        ...
        <el-col :span="9" class="tl" :offset="1">
        <el-form-item class="w" label-width="34%" label="市场监管局：" size="small" prop="department_code">
           <!-- :rules="[{required: true,message: '市场监管局信息为空', trigger: ['blur','change']}]" -->
        ...
        <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="所属村：" size="small" prop="region_name">
            <!-- :rules="[{required: true,message: '所属村信息为空', trigger: ['blur','change']}]" -->
    ...
    init () {
      ...
      if(v.companytag_code=='1001574645421581111111101'||v.companytag_code=='1001574645421581111111102'||v.companytag_code=='1001574645421581111111103'){this.activeClass=0}else{this.activeClass=1}
       ...
       v.accessoryReturnList.forEach((item,index)=>{
        ...
        if(this.formInline.region_code){
