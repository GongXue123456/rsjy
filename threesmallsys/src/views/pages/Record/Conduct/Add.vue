  ...
  <el-container class="patroladd">
    ...
    <el-form :inline="true"  status-icon ref="formInline1"  :model="formInline1"  class="demo-ruleForm">
     <el-row class="box mt20  f14">
        ...
        <el-form-item  label="小作坊名称：" size="small" class="w" label-width="34%"  prop="company_name" :rules="[{required: true,message: '请输入小作坊名称', trigger: 'blur' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入空格等特殊符号' ,trigger: ['blur','change']},{ maxlength: 50, message: '最多输入50个字符',trigger: ['blur','change'] }]">
           <el-input placeholder="小作坊名称" maxlength='50' clearable v-model="formInline1.company_name" class="input-with-select">
            </el-input>
        </el-form-item>
        </el-col>
        <el-col :span="9" class="tl" :offset="1">
