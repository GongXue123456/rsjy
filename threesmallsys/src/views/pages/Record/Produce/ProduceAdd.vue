<template>
   <el-container class="recordadd ">
       <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>新增备案/食品加工</h5>
        <div>
      ...
      <el-row class="box mt20 f14">
        ...
        <el-form-item class="w" label-width="34%" label="主体业态：" size="small" prop="business_form" >
          <!-- :rules="[{required: true,message: '请选择主体业态',trigger: ['blur','change'], }]" -->
       ...
       <el-row class="box mt20  f14">
        ...
        <el-form-item   class="w" label-width="34%" label="小作坊名称：" size="small" prop="company_name">
           <!-- :rules="[{required: true,message: '请输入小作坊名称', trigger: 'blur' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入空格等特殊符号' }]" -->
        ...
        <el-form-item class="w" label-width="34%" label="经营者姓名：" size="small"  prop="operator" >
          <!-- :rules="[{required: true,message: '请输入经营者姓名', trigger: 'blur' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入空格等特殊符号' }]" -->
         ...
         <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="身份证号：" size="small" prop="idcard" >
      ...
      <el-row class="box mt20  f14">
        ...
        <el-col :span="22" class="tl" :offset="1">
          ...
          <el-form-item  label="经营场所："  class="w" label-width="14%" size="small" prop="vill">
             <!-- :rules="[{required: true,message: '请选择经营地址', trigger: ['blur','change']}]" -->
        ...
        <el-form-item class="w " label-width="14%"   label="加工形式：" size="small" prop="produce_form_list" >
          <!-- :rules="[{required: true,message: '请选择加工形式', trigger: 'blur' }]" -->
         ...
         <el-form-item class="w" label-width="14%"  label="加工类别：" size="small" prop="producetype_codes_list" >
           <!-- :rules="[{required: true,message: '请选择加工类别', trigger: 'blur' }]" -->
         ...
         <el-form-item class="w" label-width="34%" label="面积：" size="small" prop="place_area">
            <!-- :rules="[{required: true,message: '请输入面积', trigger: 'blur'},{ pattern: /^(^[1-9](\d+)?(\.\d{1,2})?$)|(^0\.0[1-9]{1}$)|(^0\.[1-9]{1}\d{0,1}$)/, message: '只允许输入大于0的数' }]" -->
        ...
        <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="从业人数：" size="small" prop="employ_num" >
           <!-- :rules="[{required: true,message: '请输入从业人数', trigger: 'blur' },{ pattern: /^(^[1-9]{1}\d{0,6}$)*$/, message: '只允许输入最小为1的整数' }]" -->
      ...
      <el-row class="box mt20  f14">
        ...
        <el-col :span="9" class="tl" :offset="1">
         <el-form-item class="w" label-width="34%" label="所属村：" size="small" prop="region_name">
            <!-- :rules="[{required: true,message: '请选择所属村',trigger: 'blur'}]" -->
