<template>
  <el-container class="shopList ">
    <el-header class="box add bb">
        <h5 ><span class="lines"></span>备案管理/食品加工</h5>
...
    if(this.page.search_time_bigen==null){this.page.search_time_bigen='';}
    ...
    if(this.activeName==1){this.page.down_name = '食品加工待审核备案信息'}else if(this.activeName==5){this.page.down_name = '食品加工黑名单备案信息'}else if(this.activeName==3){this.page.down_name = '食品加工已归档' + statename + '备案信息'}else if(this.activeName==4){this.page.down_name = '食品加工已驳回备案信息'}
    
