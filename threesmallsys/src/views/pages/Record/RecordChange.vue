  ...
  <el-container class="patroldetail container">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
       ...
       <el-row class="box mt20  f14">
        ...
        <el-form-item class="w" label-width="14%" v-if="list.companytag_code=='1001574645421581111111101'"  label="加工形式：" size="small" prop="produce_form_list" :rules="[{required: true,message: '请选择加工形式', trigger: 'blur' }]">
        ...
        <el-form-item class="w" label-width="14%"  v-if="list.companytag_code=='1001574645421581111111103'||list.companytag_code=='1001574645421581111111105'"  label="经营范围：" size="small" prop="business_range_list" :rules="[{required: true,message: '请选择经营范围', trigger: 'blur' }]">
         ...
         <el-form-item  class="w" label-width="14%" v-if="list.companytag_code=='1001574645421581111111101'"   label="加工类别：" size="small" prop="producetype_codes_list" :rules="[{required: true,message: '请选择加工类别', trigger: 'blur' }]">
