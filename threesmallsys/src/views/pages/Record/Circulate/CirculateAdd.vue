<template>
   <el-container class="recordadd ">
       <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>新增备案/食品流通</h5>
        <div>
          <el-button  v-if="menu_btns!=null&&menu_btns.indexOf('5-2-5')!== -1" class="" size="small" type="primary" @click="submitForm('formInline')">提交归档</el-button>
      ...
      <el-row class="box mt20 f14">
       ...
       <el-row class="box mt20  f14">
        ...
        <el-col :span="9" class="tl" :offset="1" v-if="this.formInline.companytag_code=='1001574645421581111111102'">
        <el-form-item class="w" label-width="34%" label="经营者姓名：" size="small"  prop="operator" :rules="[{required: true,message: '请输入经营者姓名', trigger: 'blur' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入空格等特殊符号' }]">
         <el-input   placeholder="请输入经营者姓名" maxlength="10" clearable v-model="formInline.operator" class="input-with-select"></el-input>
        </el-form-item>
        </el-col>
        ...
        <el-form-item class="w" label-width="34%" label="法人姓名：" size="small"  prop="operator" :rules="[{required: true,message: '请输入法人姓名', trigger: 'blur' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入空格等特殊符号' }]">
         <el-input  placeholder="法人" maxlength="10" clearable v-model="formInline.operator" class="input-with-select"></el-input>
        </el-form-item>
        </el-col>
         <el-col :span="9" class="tl" :offset="1">
      ...
      <el-row class="box mt20  f14">
         ...
         <!-- { pattern:/[^_IOZSVa-z\W]{2}\d{6}[^_IOZSVa-z\W]{10}/g,message: '请输入正确的统一社会信用代码',trigger: 'blur'} -->
         <el-col  v-if="this.formInline.companytag_code=='1001574645421581111111105'" :span="9" class="tl" :offset="1">
         ...
         <el-col v-if="this.formInline.companytag_code=='1001574645421581111111102'" :span="9" class="tl" :offset="1">
        ...
        <el-form-item  label="详细地址：" class="w" label-width="34%" size="small" >
          ...
          <el-col :span="22" :offset="1" class="tl" v-if="this.formInline.companytag_code=='1001574645421581111111105'" >
         ...
         <el-col :span="22" :offset="1" class="tl" v-if="this.formInline.companytag_code=='1001574645421581111111102'" >
    ...
    <el-button size="small" type="primary">点击上传</el-button>
      ...
      <el-row class="box mt20  f14">
        ...
        <el-col :span="9" class="tl" :offset="1">
         ...
         <el-form-item class="w" label-width="34%" filterable label="网格信息员：" size="small" prop="user_code_info_list" >
            <el-select v-model="formInline.user_code_info_list" multiple  :multiple-limit='10' placeholder="请选择网格信息员" @change="change(11,formInline.user_code_info_list)">
  ...
  <div class="recordadd-upload">
              ...
              <div class="tc p15" v-if="formInline.business_form=='学校（含托幼机构）食堂（流通）'">法人证书</div>
              <div class="tc p15" v-else-if="formInline.business_form=='机关企事业单位食堂（流通）'||formInline.business_form=='工地食堂（流通）'||formInline.business_form=='其他食堂（流通）'">批准设立文件或证件</div>
        ...
        <div class="recordadd-upload">
         <el-upload 
              ...
              <el-dialog :visible.sync="dialogVisible">
               ...
               <div class="tc p15" v-if="this.formInline.companytag_code=='1001574645421581111111105'">食品经营许可证</div>
<div v-else class="tc p15">备案证</div>
        </div>
       <div class="recordadd-upload">
         <el-upload 
                ref="upload"
              ...
              <div class="tc p15" v-if="this.formInline.companytag_code=='1001574645421581111111105'">法人身份证</div>
<div v-else class="tc p15">经营者身份证</div>
        </div>
      </el-col>
     </el-row>
...
export default {
  data () {
    return {
     ...
     uploadDisabled:false,
      ...
      activeClass:0,
      list_btn:[{title: '四川省小经营店备案证（流通）',val:'1001574645421581111111102'},{title: '食品经营许可证（流通）',val:'1001574645421581111111105'}],
      formInline: {
        company_code:'',
         companytype_code:'1001574645421581000000002',
        companytag_code:'1001574645421581111111102',
        company_name: '',
        credit_code:'',
  ...
  methods: {
    init () {
       axios.get('/api/company/department/list', {state:'1',pager_openset:'500'}).then((v) => {this.options4=v.department_list }).catch(function (err) {})
     ...
     savepeople(form){
      ...
      handleRemove(file, fileList) {
          this.uploadDisabled = false;
            if(this.formInline.business_form=='学校（含托幼机构）食堂（流通）'){
           this.$set(this.formInline.accessoryList, 0,{name:'法人证书',url:''});
         }else if(this.formInline.business_form=='机关企事业单位食堂（流通）'||this.formInline.business_form=='工地食堂（流通）'||this.formInline.business_form=='其他食堂（流通）'){
      ...
      handleRemove1(file, fileList) {
          this.uploadDisabled1 = false;
           if(this.formInline.companytag_code=='1001574645421581111111105'){
