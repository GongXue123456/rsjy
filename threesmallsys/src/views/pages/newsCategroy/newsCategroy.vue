    ...
    <el-main class="p15 pt0">
      <div class="box list">
        <el-table border :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="news_category_name"  min-width="150" :show-overflow-tooltip="true"  label="培训栏目" align='center' ></el-table-column>
...
<el-dialog title="培训栏目" :visible.sync="dialogFormVisible">
