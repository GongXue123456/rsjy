      ...
      ></el-image></p>
         ...
         <el-col :span="24" class="">
          ...
          <el-select size="mini" v-model="formInline.area" clearable placeholder="请选择区县" @change="change(6,formInline.area)">
             <el-option v-for="group in options_area" :key="group.region_code" :label="group.region_name" :value="group.region_code"> </el-option>
              ...
              <!-- <el-col :span="24" class="mb10">
                <el-form-item   size="mini" prop="company_code" :rules="[{required: true,message: '请输入小作坊名称', trigger: 'blur' }]" style="pandding:0px;width:100%;margin-right:0px;">
           <el-select   v-model="formInline.company_code" filterable placeholder="请输入小作坊名称"  clearable @change="change(1,formInline.company_code)">
            <el-option  v-for="item in tableData" :key="item.company_code" :label="item.company_name" :value="item.company_code" ></el-option>
          </el-select>
        </el-form-item>
        </el-col>  -->
          <el-col :span="24" class="mb10">
                <el-form-item   size="mini" prop="company_name" class="mb5" :rules="[{required: true,message: '请输入小作坊名称', trigger: 'blur' }]" style="pandding:0px;width:100%;margin-right:0px;">
          <el-input placeholder="小作坊名称" v-model="formInline.company_name" clearable class="input-with-select" @clear="onSubmit(formInline.company_name)">
        ...
        <el-table-column  label="" class-name='aa'  fixed="right" min-width="100"  align='right'>
          <template slot-scope="scope">
            <el-button  type="primary" class="bgccac cfff disib"  size="mini" @click="change(1,scope.row.company_name)">小作坊信息</el-button>
