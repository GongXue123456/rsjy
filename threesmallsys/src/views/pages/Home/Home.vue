  ...
  <el-container class="home">
    <el-main  class="p15 pt0">
      ...
      <el-radio-button label="健康证"></el-radio-button>
          ...
          <div class="m15  c999">
            <div v-if="radio1=='备案证件'" class="nav-grid2 bf " @click="$router.push({name: 'Produce',query: {id:4}})">食品加工<div class="fr"><span class="num1">{{data2.company_willexpire_sc}}</span>个</div>
      ...
      <el-radio-button label="健康证"></el-radio-button>
          ...
          <div class="m15  c999">
            <div v-if="radio2=='备案证件'" class="nav-grid2 bf " @click="$router.push({name: 'Produce',query: {id:2}})">食品加工<div class="fr"><span class="num1">{{data3.company_expired_sc}}</span>个</div>
