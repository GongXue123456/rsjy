    ...
    <el-main class="pt0">
      ...
      <div class="echarts">
          ...
          <el-row class="mt20 c999 f14">
           <el-col :span="6">已备案小作坊<p class="mt5"><span class="c333 f25 fb mr5">{{data1.company_all}}</span>家</p></el-col>
           <el-col :span="6">食品加工<p class="mt5"><span class="c333 f25 fb mr5">{{data1.company_all_sc}}</span>家</p></el-col>
      ...
      <div class="box list  mt20">
         <div class="title f15">
          <p><span class="triangle-right fl ml10 mr10"></span>小作坊统计明细表</p>
        ...
        <el-table  class="mt20  clear" border :data="tableData" style="width: 100%" fit>
          ...
          <el-table-column prop="company_all" label="已备案小作坊" align="center"></el-table-column>
          <el-table-column prop="company_all_sc" label="食品加工" align="center"></el-table-column>
...
    if(this.page.search_time_bigen==null){this.page.search_time_bigen='';}
    ...
    if(this.page.search_time_end!=''&&this.page.search_time_bigen!=''){
        statename = this.page.search_time_bigen+'至'+this.page.search_time_end+'小作坊统计明细表';
    }else{
        statename ='小作坊统计明细表';
    }
