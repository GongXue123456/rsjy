      ...
      <el-row class="mt20" style="text-align:left;padding-left:10px" :gutter="10">
        <el-form :inline="true" :model="page" label-position="left">
          <el-row>
            ...
            <el-col :span="20">
              <el-form-item size="small" prop="checkAll" >
                <el-checkbox
...
export default {
  ...
  mounted() {
    this.page.user_province = this.$route.query.province;
    this.page.user_city = this.$route.query.city;
    this.page.user_area = this.$route.query.area;
    // this.page.department_code = this.$route.query.id;
    this.fetchRegionList();
  },
  methods: {
    init(params) {
      axios.get("/api/user/manage/list", params).then(response => {
    ...
    submitUser() {
      ...
      axios
        .post("/api/departmentUser/save", { department_user_list })
        .then(response => {
          this.$router.back();
        });
    },
    ...
    handleCheckedChange(value) {
      ...
      this.page.user_towns = checkedList.toString();
      this.page.pager_offset = "0";
