    ...
    <el-header class="box add bb">
      ...
      <div>
        <el-button
          ...
          size="small"
          type="primary"
          @click="$router.push({path: 'supervisorAdd',query:{
            id:$route.query.id,
    ...
    <el-main class="pt0">
      <el-row class="box search mt20" :gutter="10">
        <el-form :inline="true" :model="page" class="demo-form-inline">
          ...
          <el-col :span="4">
            <el-form-item size="small">
              <el-select v-model="page.state" clearable placeholder="请选择状态">
                <el-option
  ...
  methods: {
    init(params) {
      axios.get("/api/departmentUser/list", params).then(response => {
        ...
        this.tableData = response.department_user_list;
    ...
    handleDelete(row) {
      let { user_code } = row;
      axios.delete("/api/departmentUser/delete", {
          department_code: this.$route.query.id,
          user_code
        })
        .then(response => {
