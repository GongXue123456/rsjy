<template>
  <el-container class="shopList ">
    <el-header class="box add bb">
        <h5 ><span class="lines"></span>小作坊区域管理</h5>
        <div><el-button  class=""  icon="el-icon-plus" size="small" type="primary" @click="$router.push({path: 'companyArea/add'})">新增小作坊区域</el-button></div>
    </el-header>
   ...
   <el-row class="box search">
    ...
    <div class="box list">
      <el-table border  :data="tableData"  style="width: 100%">
        ...
        <el-table-column prop="company_area_name"  min-width="150" :show-overflow-tooltip="true"  label="小作坊区域名称" align='center' ></el-table-column>
