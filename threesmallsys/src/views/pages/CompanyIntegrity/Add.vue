  ...
  <el-container class="patroladd">
    ...
    <el-form :inline="true"  status-icon ref="formInline"  :model="formInline"  class="demo-ruleForm">
     <el-row class="box mt20  f14">
        ...
        <el-form-item label="选择小作坊：" class="w" label-width="25%" prop="company_name" >
          <el-input v-model="formInline.company_name" size="small" disabled>
            <el-button slot="append" icon="el-icon-search" @click="handleChooseCompany">请选择小作坊</el-button>
          </el-input>
        </el-form-item>
        </el-col> 
      ...
      <el-input class="w" type="textarea" :rows="3" placeholder="请输入备注"  v-model="formInline.remark"> </el-input>
        ...
        <el-col :span="4" class="mr10">
         ...
         <el-input placeholder="小作坊名称" clearable v-model="page.company_name" class="input-with-select">
            </el-input>
        </el-form-item>
        </el-col>
         <el-col :span="4" class="mr10">
        ...
        <el-table-column type="index" align='center' width="60"  label="序号"></el-table-column>
         <el-table-column prop="company_name" min-width="120" :show-overflow-tooltip="true"  label="小作坊名称" align='center'></el-table-column>
