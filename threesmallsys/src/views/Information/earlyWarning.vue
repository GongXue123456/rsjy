<template>
  <div class="body">
    <div class="title" ref="Top"><img class="mr10" src="../../assets/image/dashujulogo.png">中国小作坊数智云平台大数据中心 <span class="f13 ml10">食品加工经营者</span><a  class="right_btn f13 cfff disib"
       ...
       <el-col :span="6">
         <div class="grid-content bg-purple1 fl " >
          <div class="left-top ml10" ref="leftTop">
            <div class=" title1 tl f16">食品加工经营者备案<span class="pt10 fr f30">915<span class="pt10 tr f13">条</span></span></div>
          ...
          <div class="fl p5" v-if="item.companytype_code=='1001574645421581000000001'">食品加工</div>
         ...
         <div class="grid-content bg-purple1 fl" ref="Purple3">
          ...
          <!-- <div class="right-center"  ref="rightCenter">
            ...
            <div class="a w f14 tc" ref="rightCenter1">
              <div style="width:40%" class="fl cfff mb5">小作坊</div>
          ...
          <div class="right-top"  ref="rightBottom">
            <div class="pt10 pl10 mb10 tl f16">溯源管理</div>
             <div class="a w f14 tc" ref="rightCenter1">
              <div  class="fl aa cfff mb5">小作坊名称</div>
  ...
  <el-col :span="7" class="lh150">购买地址：{{item.supplier_address}}</el-col>
    ...
    <el-table-column align='center' prop="produce_name" label="加工人员"> </el-table-column>
