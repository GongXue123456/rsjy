...
const patrolonway = () => import('../pages/patrol/onway')
...
const selfexaminationcheck = () => import('../pages/selfexamination/check')
const selfexaminationdetail = () => import('../pages/selfexamination/detail')
const kitchenWasteRefuse = () => import('../pages/kitchenWasteRefuse')
const kitchenWasteRefuseCreate = () => import('../pages/kitchenWasteRefuse/create')
const tipoffs = () => import('../pages/tipoffs')
const tipoffscreate = () => import('../pages/tipoffs/create')
const tipoffsdetail = () => import('../pages/tipoffs/detail')
const casecenter = () => import('../pages/casecenter')
const casecenterwait = () => import('../pages/casecenter/wait')
const casecentergoto = () => import('../pages/casecenter/goto')
const casecentercomplete = () => import('../pages/casecenter/complete')
...
const LedgerList=()=>import('../pages/Ledger/List')
...
const view2scan=()=>import('../pages/home/view2scan')
