    ...
    <div class="information bgcfff">
     <van-form >  
        <div class="card1  p15 f16 pr">
          ...
          <van-field readonly v-model="form.storage_in_batch"  label="入库批次（加工日期）" input-align="right"/>
          ...
          <van-field readonly v-model="form.storage_out_batch"  label="出库批次（加工日期）" input-align="right"/>
