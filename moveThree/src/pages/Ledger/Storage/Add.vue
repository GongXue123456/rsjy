    ...
    <div class="information bgcfff">
     <van-form validate-first @submit="onSubmit"  @failed="onFailed">  
        <div class="card1  p15 f16 pr">
          ...
          <van-field  v-model="form.storage_in_batch"  label="入库批次（加工日期）" placeholder="请输入入库批次（加工日期）" input-align="right"/>
          ...
          <van-field v-model="form.storage_out_batch"  label="出库批次（加工日期）" placeholder="请输入出库批次（加工日期）" input-align="right"  />
