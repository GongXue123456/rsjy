    ...
    <div class="information bgcfff">
     <van-form validate-first @submit="onSubmit"  @failed="onFailed">  
        <div class="card1  p15 f16 pr">
          ...
          <van-field  v-model="form.mixture_batch"  label="批次（加工日期）" placeholder="请输入批次（加工日期）" input-align="right" />
          ...
          <van-field  v-model="form.mixture_batch1"  label="批次（加工日期）" placeholder="请输入批次（加工日期）" input-align="right" />
          ...
          <van-field  v-model="form.mixture_batch2"  label="批次（加工日期）" placeholder="请输入批次（加工日期）" input-align="right" />
