        ...
        <div v-if="this.active==1?true:false" style="margin-bottom:60px;margin-top:100px">
         ...
         <div class="firstPage" v-if="this.active==2?true:false">
          ...
          <div class="card1  p15 f16 pr">
            ...
            <van-field v-model="form.company_name" label="小作坊名称" placeholder="请输入小作坊名称" @input="form.company_name=form.company_name.replace(/[, ]/g,'')" input-align="right" :rules="[{ required: true, message: '请输入小作坊名称' },{ pattern: /^[A-Za-z0-9\u4e00-\u9fa5]+$/, message: '不允许输入特殊符号' }]" />
