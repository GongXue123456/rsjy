      ...
      <van-tabs  v-model="activeName">
       <van-tab title="基础信息" name="a">
         <div class="card p15 pr">
          ...
          <div class="cardInfo  f16">
            ...
            <p class="pt15"><span v-if="form.companytype_code==='1001574645421581000000001'">食品加工</span><span v-else-if="form.companytype_code==='1001574645421581000000002'">食品流通</span><span v-else-if="form.companytype_code==='1001574645421581000000003'">食品餐饮</span></p>
       ...
       <van-tab title="经营信息" name="b">
         <div class="card1  p15 f16 pr">
          ...
          <van-field v-if="form.companytag_code==='1001574645421581111111101'" readonly clickable label="加工形式" type="textarea" rows="1" autosize v-model="options1_1[1]" placeholder="请选择加工形式" :rules="[{ required: true, message: '请选择加工形式' }]" input-align="right" right-icon="arrow" @click="showCheckbox(3)" />
           ...
           <van-field v-if="form.companytag_code==='1001574645421581111111101'" readonly clickable label="加工类别" type="textarea" rows="1" autosize v-model="options2_1[1]" placeholder="请选择加工类别" :rules="[{ required: true, message: '请选择加工类别' }]" input-align="right" right-icon="arrow" @click="showCheckbox(4)"/>
