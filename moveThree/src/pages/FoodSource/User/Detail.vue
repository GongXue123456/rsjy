    ...
    <div class="information bgcfff">
        ...
        <div class="card1  p15 f16 pr">
         ...
         <van-field readonly v-model="item.sell_count"  label="数量"  autosize input-align="right" />
          <van-field readonly  v-model="item.sale_product_name" label="产品名称"  input-align="right" />
          <van-field readonly  v-model="item.sale_company_name" label="产品接收单位"  input-align="right" />
