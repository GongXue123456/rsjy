  ...
  <div class="header">
    ...
    <div class="body">
      ...
      <van-form  @submit="onSubmit" class="form" @failed="onFailed">
        ...
        <van-field readonly clickable  type="textarea" v-model="place_operate" rows="1" autosize  placeholder="请输入小作坊所在地"  right-icon="arrow" @click="show_Picker" :rules="[{ required: true, message: '请选择小作坊所在地' }]" class="card" />
