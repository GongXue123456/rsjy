    ...
    <div class="information bgcfff">
     <van-form >  
        <div class="card1  p15 f16 pr">
          ...
          <van-field readonly v-model="form.mixture_batch"  label="批次（生产日期）" input-align="right"/>
          ...
          <van-field readonly v-model="form.mixture_batch1"  label="批次（生产日期）"  input-align="right"/>
          ...
          <van-field readonly v-model="form.mixture_batch2"  label="批次（生产日期）"  input-align="right"/>
