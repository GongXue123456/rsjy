    ...
    <div class="information bgcfff">
     <van-form >  
        <div class="card1  p15 f16 pr">
          ...
          <van-field readonly v-model="form.produce_unit"  label="原辅料生产单位" input-align="right"/>
          <van-field readonly v-model="form.produce_licence"  label="生产许可证编号" input-align="right"/>
          <van-field readonly v-model="form.produce_batch"  label="生产日期（批号）"  input-align="right"/>
