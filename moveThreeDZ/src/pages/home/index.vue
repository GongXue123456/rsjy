<template>
  <div>
    ...
    <van-row class="first">
      <van-col span="24">
         <div class="user-name"><div class="name pl20">您好，{{user_name}}</div><span class="ml20 disib" v-if="user_type=='平台管理员'||user_type=='超级管理人员'||user_type=='协管员'">三小管理员</span><span v-else-if="user_type=='举办者'||user_type=='农家乐'||user_type=='乡厨酒店'||user_type=='食堂'||user_type=='配送企业'||user_type=='食品经营者'">三小企业</span><span v-else-if="user_type=='乡厨'">乡厨</span></div>
    ...
    <van-row v-if="user_type=='平台管理员'||user_type=='超级管理人员'||user_type=='协管员'" class="second p15" >
      ...
      <van-col   span="12" :style="{ width: fullWidth + 'px' }">
        <!-- <a href='http://139.155.11.121:8089/qy/receiveFoodSource/findByList'> -->
          <div class=""  @click="$router.push('/foodSource')">
             <!-- @click="$router.push('/foodSource')" -->
      ...
      <van-col class="ml15"  span="12" :style="{ width: fullWidth + 'px' }">
        <!-- <a href='http://139.155.11.121:8089/qy/receiveFoodSourceSample/findByList'> -->
          <div class="" @click="$router.push('/sampleListController')">
             <!-- @click="$router.push('/sampleListController')" -->
    ...
    <van-row v-if="user_type=='食品经营者'&&company_code" class="second p15" >
      ...
      <van-col  span="12" :style="{ width: fullWidth + 'px' }">
        <!-- <a href="http://139.155.11.121:8089/qy/receiveFoodSource/findThreeFoodSource"> -->
      ...
      <van-col class="ml15"  span="12" :style="{ width: fullWidth + 'px' }">
        <!-- <a href="http://139.155.11.121:8089/qy/receiveFoodSourceSample/findAll"> -->
        <!-- @click="$router.push('/sampleList')" -->
      ...
      <van-col class="ml15"  span="12"  :style="{ width: fullWidth + 'px' }">
        <!-- <a href="http://118.122.73.129:8080/qy/receiveThreeAnnouncement/viewList"> -->
