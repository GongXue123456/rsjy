      ...
      <van-tabs  v-model="activeName" :class="form.filing_state===2&&id1!=1?'mb50':(form.filing_state===3&&(form.state===1||form.state===4) ? 'mb100' : 'mb0')">
        ...
        <van-tab title="经营信息" name="b">
         <div class="card1  p15 f16 pr">
          ...
          <van-field readonly v-if="form.companytag_code==='1001574645421581111111101'"  clickable label="生产形式" type="textarea" rows="1" autosize v-model="options1_1[1]" placeholder="请选择生产形式"  input-align="right"  />
           ...
           <van-field readonly v-if="form.companytag_code==='1001574645421581111111101'"  clickable label="生产类别" type="textarea" rows="1" autosize v-model="options2_1[1]" placeholder="请选择生产类别"  input-align="right" />
       ...
       <van-tab title="基础信息" name="a">
         <div class="card p15 pr">
          ...
          <div class="cardInfo  f16">
            <p class="f15">证照类型</p>
            <p class="pt20"><span v-if="form.companytype_code==='1001574645421581000000001'">食品生产</span><span v-else-if="form.companytype_code==='1001574645421581000000002'">食品流通</span><span v-else-if="form.companytype_code==='1001574645421581000000003'">食品餐饮</span></p>
        ...
        <div class="card p15 pr" >
         ...
         <div class="card1  p15 pb30 f16 pr">
          <van-field  v-model="form.company_name" readonly label="企业名称"  input-align="right" />
          ...
          <van-field readonly clickable label="企业所在地" type="textarea" rows="1" autosize v-model="form.place_operate"  input-align="right" />
