<template>
  <div class="body">
    <div class="title" ref="Top">中国食安数智云大数据中心 <a  class="right_btn f13 cfff disib"
  ...
  methods: {
    ...
    drawPie() {
      ...
      var option3 = {
        ...
        tooltip: {show: false},
        legend: { data: ["食安数智云"],textStyle: {fontSize: 12,color: "#F1F1F3"},right: "10%"},
        calculable: true,
        xAxis: [{
            axisLabel: {color: "#315070",interval: 0,rotate: 40},
            axisLine: {lineStyle: { width: 1,color: "#315070"}},
        ...
        series: [{name: "食安数智云",type: "bar",barWidth: 10,data: [0, 0, 0,0, 0,0,0, 0],color: "#C14AA6"}]
      };
