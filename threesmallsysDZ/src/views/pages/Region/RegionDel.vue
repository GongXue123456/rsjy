    ...
    <el-main class="pt0">
      <el-form :inline="true" status-icon ref="form" :model="form" class="demo-ruleForm">
        <el-row class="box mt20 f14">
          <el-col :span="24" class="patroladd-title bgcfbe tl mb20 pl15">撤销区域信息</el-col>
          <el-col :span="22" class="tl" :offset="1">
            <el-row class="box mt20 f14">
              <el-form-item class="w" label-width="120px" label="选择撤销区域：" size="small">
                <el-col :span="4">
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      let html = '您确定要永久删除【' + this.provinceTemp.region_name;
      ...
      if(this.villTemp.region_name !== undefined){
        html+= this.villTemp.region_name;
      }
      html+= '】该区域, 是否继续?';
      this.$confirm(html, '提示', {
          ...
          axios.delete("/api/region/delete", this.form).then(v => {
