    ...
    <el-row class="box search mt20">
       <el-form :inline="true" :model="page" class="demo-form-inline">
        ...
        <el-col :span="4" class="mr10">
             <el-form-item size="small" >
         <el-input placeholder="企业名称、手机号" clearable @clear='onSubmit' v-model="page.company_name" class="input-with-select">
            </el-input>
        </el-form-item>
        </el-col>
        <el-col :span="4" class="mr10">
    ...
    <div class="box list">
      ...
      <template scope="scope">
        <el-popover
         ...
         <el-table-column prop="company_name" min-width="80" :show-overflow-tooltip="true"  label="企业名称" align='center'></el-table-column>
