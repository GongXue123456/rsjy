<template>
  <el-container class="recorddetail container">
    <el-header class="box add bb">
        ...
        <div>
        <el-button  v-if="menu_btns!=null&&menu_btns.indexOf('5-2-2')!== -1&&this.id1==3&&list.state!=3"  type="danger" size="small" @click="off(list.company_code)">注销备案</el-button>
         <el-button  v-if="menu_btns!=null&&menu_btns.indexOf('5-2-3')!== -1&&this.id1==3&&list.state!=3"  type="info" size="small" @click="addBlackList(2)">加入黑名单</el-button>
      <el-button  v-if="menu_btns!=null&&menu_btns.indexOf('5-2-7')!== -1&&list.isblacklist==2" type="info" size="small" @click="addBlackList(1)">加入白名单</el-button>
      <el-button  v-if="menu_btns!=null&&menu_btns.indexOf('5-2-4')!== -1&&this.id1==3&&list.state!=3" size="small" type="primary" @click="recordChange(list.company_code,1)">变更备案</el-button>
    ...
    <div class="box title tl mt20 mb20 f16">
    ...
    <el-tab-pane  label="基本信息" name="1">
        <el-row class="box mt20 f14">
          ...
          <span class="left">主体类型：</span><span class="c333">四川省小经营店备案证（流通）</span>
        </el-col>
         <el-col :span="9" class="tl mb20" :offset="1">
     ...
     <el-row class="box mt20  f14 c666">
        ...
        <el-col v-if="list.companytag_code=='1001574645421581111111105'" :span="9" class="tl mb20" :offset="1">
          <span class="left">社会信用代码：</span><span class="c333">{{list.credit_code}}</span>
        </el-col>
         <el-col v-if="list.companytag_code=='1001574645421581111111102'" :span="9" class="tl mb20" :offset="1">
        ...
        <el-col :span="22" class="tl mb20" :offset="1">
         ...
         <el-col v-if="list.companytag_code=='1001574645421581111111105'" :span="22" class="tl mb20" :offset="1">
          <span class="left">经营范围：</span><span class="c333">{{list.business_range}}</span>
         </el-col>
         <el-col v-if="list.companytag_code=='1001574645421581111111102'" :span="22" class="tl mb20" :offset="1">
