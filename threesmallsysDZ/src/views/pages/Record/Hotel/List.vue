<template>
  <el-container class="shopList">
    <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>乡村酒店管理</h5>
        <div> <el-button size="small" type="primary" @click="godetail('','0','乡村酒店')">新增乡村酒店</el-button></div>
    </el-header>
    ...
    <el-row class="box search mt20">
       <el-form :inline="true" :model="page" class="demo-form-inline">
        ...
        <el-col :span="4" class="mr10">
             <el-form-item size="small" >
         <el-input placeholder="乡村酒店名称、手机号" clearable @clear='onSubmit' v-model="page.company_name" class="input-with-select">
            </el-input>
        </el-form-item>
        </el-col>
        <el-col :span="4" class="mr10">
    ...
    <div class="box list">
      ...
      <template scope="scope">
        <el-popover
         ...
         <el-table-column prop="company_name" min-width="80" :show-overflow-tooltip="true"  label="乡村酒店名称" align='center'></el-table-column>
        ...
        <el-table-column label="操作" width="120" fixed="right"  align='center'>
          <template slot-scope="scope">
           <el-button type="text" class="orange" size="small"  @click="godetail(scope.row.user_code,'1','乡村酒店')">编辑</el-button>
...
      if(this.page.endtime==null){this.page.endtime='';}
      if(this.page.addtime==null){this.page.addtime='';}
      this.page.down_name = '乡村酒店管理列表信息'
      axios.fileget('/api/report/export_hotel_search', this.page).then((v) => {
      })
    },
   check(){
     axios.get('/api/report/check', {down_name:'export_hotel_search'}).then((v) => {
       if(v==true){
