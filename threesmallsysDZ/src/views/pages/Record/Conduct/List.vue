<template>
  <el-container class="shopList">
    <el-header class="box add bb">
        <h5 class="mb10"><span class="lines"></span>举办者管理</h5>
        <div><el-button size="small" type="primary" @click="godetail('','0','举办者')">新增举办者</el-button></div>
    </el-header>
    ...
    <div class="box list">
      ...
      <template scope="scope">
        ...
        <el-table-column label="操作" width="120" fixed="right"  align='center'>
          <template slot-scope="scope">
           <el-button type="text" class="orange" size="small" @click="godetail(scope.row.user_code,'1','举办者')">编辑</el-button>
...
      if(this.page.endtime==null){this.page.endtime='';}
      if(this.page.addtime==null){this.page.addtime='';}
      this.page.down_name = '举办者管理列表信息'
      axios.fileget('/api/report/export_conduct_search', this.page).then((v) => {
      })
    },
   check(){
     axios.get('/api/report/check', {down_name:'export_conduct_search'}).then((v) => {
       if(v==true){
