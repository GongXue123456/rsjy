  ...
  <el-container class="patroladd">
    ...
    <el-form :inline="true"  status-icon ref="formInline"  :model="formInline"  class="demo-ruleForm">
     <el-row class="box mt20  f14">
        ...
        <el-form-item class="w" label-width="34%" label="权限名称：" size="small"  prop="role_name" :rules="[{required: true,message: '请输入企业名称', trigger: 'blur' },{ pattern: /^[\u4e00-\u9fa5]+$/, message: '权限名称请输入中文' }]">
