  ...
  <el-container class="camadd">
    <el-header class="box add bb">
      <h5 v-if="form.company_area_code" class="mb10">
        <span  class="lines"></span>编辑企业区域
      </h5>
      <h5 v-else class="mb10">
        <span  class="lines"></span>新增企业区域
      </h5>
      <div>
    ...
    <el-main class="pt0">
      ...
      >
        <el-form-item label="企业区域名称：" prop="company_area_name"  :rules="[{required: true,message: '请输入企业区域名称', trigger: ['blur','change']}]">
          <el-input v-model="form.company_area_name" size="small" placeholder="请填入企业名称"></el-input>
        </el-form-item>
        <el-form-item label="绑定企业：" prop="company_name" :rules="[{required: true,message: '请绑定企业', trigger: ['blur','change']}]">
          <el-input v-model="form.company_name" size="small" disabled>
            <el-button slot="append" v-if="form.company_area_code" disabled icon="el-icon-search" @click="handleChooseCompany">请选择企业</el-button>
             <el-button v-else slot="append"   icon="el-icon-search" @click="handleChooseCompany">请选择企业</el-button>
          </el-input>
        </el-form-item>
      </el-form>
