  ...
  <el-container class="shopList">
       ...
       <el-form :inline="true" :model="page" class="demo-form-inline">
        ...
        <el-col :span="4" class="mr10">
         <el-form-item size="small">
           <el-select v-model="page.business_form" clearable placeholder="企业类型" @change="change(1,page.business_form)">
    ...
    <div class="box list">
       <el-table border :data="tableData" style="width: 100%"  id='out-table'>
        ...
        <el-table-column prop="business_form"  min-width="120" :show-overflow-tooltip="true"  label="企业类型" align='center' ></el-table-column>
