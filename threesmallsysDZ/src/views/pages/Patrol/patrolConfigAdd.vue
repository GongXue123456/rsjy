    ...
    return {
      ...
      activeClass:0,
       ...
       checked1: true,
        ...
        {name:'food_inspection',val:'生产的首批食品是否进行检验（合格,不合格）',val1:['合格','不合格']},
        {name:'food_inspection_count',val:'每年对其生产的食品检验次数（合格,不合格）',val1:['合格','不合格']},
        {name:'related_credentials',val:'进货查验、保存查验记录及相关凭证（合格,不合格）',val1:['合格','不合格']},
        {name:'ban_production_operation',val:'禁止生产经营（合格,不合格）',val1:['合格','不合格']},
        {name:'production_operation',val:'生产经营（合格,不合格）',val1:['合格','不合格']},
